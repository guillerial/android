...
import es.indios.markn.data.local.Db;
import es.indios.markn.data.local.DbOpenHelper;
import es.indios.markn.data.model.Ribot;
import es.indios.ribot.androidboilerplate.test.common.TestDataFactory;
import es.indios.ribot.androidboilerplate.util.DefaultConfig;
import es.indios.ribot.androidboilerplate.util.RxSchedulersOverrideRule;
